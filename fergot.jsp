...
rst=stmt.executeQuery("select question from customer where email='"+request.getParameter("email")+"' ");
if(rst.next()){
%>
...
<input name="email" type="hidden" value="<%= request.getParameter("email") %>" />
  <table width="480" border="1" align="center">
    <tr>
      <td width="150">Answer this Question </td>
      <td width="257"><input name="question" type="text" id="question" size="50"  value="<%= rst.getString(1) %>"/></td>
    </tr>
    <tr>
      <td>Answer</td>
...
rst=stmt.executeQuery("select password from customer where email='"+request.getParameter("email")+"' and question='"+request.getParameter("question")+"' and answer='"+request.getParameter("answer")+"' ");
if(rst.next()){
  %>
